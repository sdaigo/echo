---
name: prd-architect
description: プロダクト要求定義書(PRD)を、リサーチ結果とテンプレートに基づいて精密に作成するスキル。
...
### 1. `docs/ideas/` から最新のアイデアや技術調査メモを読み取り、コンテキストを把握する
...
`initial-requirements.md` の内容をもとにテンプレート(`./template.md`)に従ってPRDを作成する。
...
「PRDの作成が完了しました。特に[リスク箇所]について確認が必要です。
承認いただけたら、次は機能設計書(functional-design.md)に進みますか？」
